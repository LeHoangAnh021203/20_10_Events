...
export const translations: Record<Language, Translations> = {
  vi: {
    ...
    // Greeting card specific
    faceWashGreeting: "Nhân ngày 20/10, Face Wash Fox chúc",
    ...
    termsContent: [
      ...
      "DVCT sẽ được áp dụng từ sau 1 ngày làm việc kể từ thời điểm phát sinh lời nhắn gửi và có HSD đến 9/11/2025",
      "Áp dụng với tất cả hình thức thanh toán;",
      "Không áp dụng DVCT được tặng vào ngày 20/10 và thứ 7, Chủ nhật.",
